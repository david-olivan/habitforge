...
# (str) The Android project directory. It should be a directory with a build.gradle
# file in it. By default, it's set to be the directory where the .spec file is.
#android.p4a_dir =
